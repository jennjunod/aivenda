...
1. [Create database with Aiven](https://github.com/jennjunod/aivenda/edit/main/README.md#create-service-in-your-aiven-account)
2. [Prisma Client for database access](https://github.com/jennjunod/aivenda/edit/main/README.md#using-the-relational-databases-article-from-prisma-create-project-setup)  (Using JavaScript and MySQL)
3. [Write to database](https://github.com/jennjunod/aivenda/edit/main/README.md#create-a-new-file-named-writejs-to-add-the-following-code-to-it)
4. [Read from database](https://github.com/jennjunod/aivenda/edit/main/README.md#create-a-new-file-named-readjs-to-add-the-following-code-to-it)
